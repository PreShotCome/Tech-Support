...
def build_plan(client, symbols: list[str], min_trade_dollars: float) -> list[Plan]:
    ...
    for sym in symbols:
        ...
        if abs(delta_val) < min_trade_dollars:
            continue
...
def main():
    ...
    plan = build_plan(client, args.symbols, args.min_trade_dollars)
